...
async def create_list_with_calendar_days(
    ...
    """
    Create a list of calendar days plus empty cells.
...
async def generate_base_calendar(
    ...
    """
    Create buttons for the calendar.
...
async def get_month_range(
    ...
    """
    Return the number of columns for the calendar
    and the number of cells in the calendar field.
