...
state_dict = {
    "account_name": (
        "Введите название счета по которому вас интересуют расходы.",
        SearchState.action,
    ),
    "amount_gte": (
    ...
    "create_at_after": (
        "Введите дату больше которой вас интересуют расходы",
        SearchState.action,),

    "category_name": (
        "Введите имя категории, по которой вас интересуют расходы",
        SearchState.action,
    )
}
